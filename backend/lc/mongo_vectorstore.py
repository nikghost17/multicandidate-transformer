...
Each document:
{
    ...
    "metadata":     {                   # rich metadata from section_splitter
        "section_type": "experience",
        "section_title": "Work Experience",
        "original_filename": "alice_resume.pdf",
        "extraction_method": "pymupdf",
        "source_type": "resume",
        "indexed_at": "2026-07-31T12:00:00Z"
    }
}
...
def index_resume(
    ...
    for i, (doc, emb) in enumerate(zip(docs, embeddings)):
        # Preserve rich metadata as-is (section_type, section_title, etc.)
        # Only coerce non-serializable values to strings
        metadata = {}
...
def search(
    ...
    section_type : optional — filter by section (e.g. "skills", "experience")
    ...
    if section_type:
        mongo_filter["metadata.section_type"] = section_type

    # Fetch documents — include metadata for rich results
